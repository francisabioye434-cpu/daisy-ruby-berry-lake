...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B1oIDEt7.mjs");
...
var manifest = { "b6bcc7a864fa0da22ccffc87331cb9934c2ef88fb683110a3905e47f7f7ff80e": {
	functionName: "loadSlate_createServerFn_handler",
	importer: () => import("./load-slate-DY-flD6n.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DcSwOfsq.mjs").then((n) => n.t),
